...
export default function VaultUpload({ username }) {
    ...
    <div className="w-full max-w-md p-8 border backdrop-blur-xl bg-white/5 border-white/10 rounded-3xl">
      {!username && (
        <div className="mb-6 rounded-3xl border border-red-400/20 bg-red-500/10 p-4 text-sm text-red-100">
          You must be logged in to upload to your vault.
        </div>
      )}
      <h2 className="text-2xl font-serif text-gold-400 mb-6">
        The Personal Vault
      </h2>
      ...
      <form onSubmit={handleUpload} className="flex flex-col gap-4">
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full p-3 mt-1 text-sm bg-black/50 border border-white/10 rounded-xl text-white focus:outline-none focus:border-gold-500"
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full p-3 mt-1 text-sm bg-black/50 border border-white/10 rounded-xl text-white focus:outline-none focus:border-gold-500"
            placeholder="e.g. The Synthwave Kids"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full p-3 mt-1 text-sm bg-black/50 border border-white/10 rounded-xl text-white focus:outline-none focus:border-gold-500"
            placeholder="e.g. nostalgic, calm, energetic"
          />
        </div>
